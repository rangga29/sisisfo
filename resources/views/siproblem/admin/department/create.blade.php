...
@section('content')
    <div class="row">
        <div class="col-12 mb-2">
            <div class="page-title-box">
                <h4 class="page-title">TAMBAH DATA DEPARTMENT</h4>
            </div>
            @if($errors->any())
    ...
    <form action="{{ route('siproblem.admin.department.store') }}" method="POST">
        @csrf
        <div class="row g-3">
            <div class="col-sm-6">
                <label for="add_dp_code" class="form-label fw-bolder">Kode Department *</label>
                <input type="text" class="form-control" name="dp_code" id="add_dp_code" placeholder="Kode Department" required>
            </div>

            <div class="col-sm-6">
                <label for="add_dp_name" class="form-label fw-bolder">Nama Department *</label>
                <input type="text" class="form-control" name="dp_name" id="add_dp_name" placeholder="Nama Department" required>
            </div>
            ...
            <div class="col-sm-6">
                ...
                <select class="form-select" name="dp_group" id="add_dp_group" required>
                    ...
                    <option value="NON DIREKTORAT">Non Direktorat</option>
